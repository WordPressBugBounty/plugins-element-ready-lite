...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_posts_wrap__area_attr')); ?>>
            <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_posts_container_attr')); ?>>
                ...
                ?>
                        <?php if ($query_post->current_post == 0) : ?>
                            ...
                            <div class="quomodo-col-sm-12 quomodo-col-md-6 element__ready__left___post">
                                <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_post_item_attr')); ?>>
