...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_info_box_attr')); ?>>
            ...
            <?php if (!empty($settings['list_content'])) : ?>
                <div class="info__box__list">
                    <?php foreach ($settings['list_content'] as $content) : ?>
                        ...
                        ?>
                        <div class="single__info__box elementor-repeater-item-<?php echo esc_attr($content['_id']); ?>">
