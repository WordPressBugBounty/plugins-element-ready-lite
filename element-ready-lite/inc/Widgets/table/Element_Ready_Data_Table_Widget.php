...
class Element_Ready_Data_Table_Widget extends Widget_Base
{
    ...
    protected function render($instance = [])
    {
        ...
        $this->add_render_attribute('datatable_attr', 'data-options', wp_json_encode($options_array));

?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('datatable_attr')); ?>>
