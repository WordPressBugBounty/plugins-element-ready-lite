        ...
        if (!empty($this->get_available_menus())) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw'       => sprintf('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus Option</a> to create one.', admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator' => 'before',
                ]
            );
        }
...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_menu_attr')); ?>>
