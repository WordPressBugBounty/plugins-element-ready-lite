...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('copyright_text_wrap_attr')); ?>>
            <?php if (!empty($settings['copyright_text'])) : ?>
                <?php
                $copyright_text  = str_replace(['{COPYRIGHT}', '{YEAR}'], ['&copy;', gmdate('Y')], $settings['copyright_text']);
