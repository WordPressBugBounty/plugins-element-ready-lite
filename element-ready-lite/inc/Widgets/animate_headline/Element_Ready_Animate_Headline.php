...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('_main_wrap_attr')); ?>>
            <div <?php echo wp_kses_post($this->get_render_attribute_string('_animate_headline_active_attr')); ?>>
