    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic', 'gradient'],
                'separator' => 'before',
                'selector' => '{{WRAPPER}} .single__price:hover .single__price__header,{{WRAPPER}} .single__price.price__active .single__price__header,{{WRAPPER}} .single__price.price__active .single__price__header .new__price',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .single__price.price__active .price__title h3' => 'color: {{VALUE}}',
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Background', 'element-ready-lite'),
                'types'    => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .single__price:hover .single__price__header .price__subtitle,{{WRAPPER}} .single__price.price__active .single__price__header .price__subtitle,{{WRAPPER}} .single__price.price__active .single__price__header .price__title h3 ',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .single__price .new__price' => 'color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .single__price:active .new__price' => 'color: {{VALUE}}',
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single__price__header .new__price,{{WRAPPER}} .single__price__style__11 .new__price, {{WRAPPER}} .single__price .new__price',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .single__price .new__price' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .single__price .price__rate h3' => 'margin: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .single__price .old__price' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single__price__header .old__price,{{WRAPPER}} .single__price__style__11 .old__price, {{WRAPPER}} .single__price .old__price',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .single__price .old__price' => 'margin: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .single__price .price__currency' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single__price__header .price__currency,{{WRAPPER}} .single__price__style__11 .price__currency, {{WRAPPER}} .single__price .price__currency',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .single__price .price__currency' => 'margin: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .single__price .period__price' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single__price__header .period__price,{{WRAPPER}} .single__price__style__11 .period__price,{{WRAPPER}} .single__price .period__price',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .single__price .period__price' => 'display: {{VALUE}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .single__price .period__price' => 'margin: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
        ...
        $this->add_control(
            'element_ready_desc_sr_hover_color',
            [
                'label' => esc_html__('Hover Color', 'element-ready-lite'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single__price:hover .price__desc' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'pricing_features_item_hover_color',
            [
                'label'     => esc_html__('Item Hover Color', 'element-ready-lite'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single__price:hover .single__price__body ul li' => 'color: {{VALUE}}',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single__price:hover ul li' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price:hover ul li i' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price:hover .price_btn' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price:hover .single__price__header .price__title h3' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price:hover .single__price__header .price__rate .new__price' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price:hover .single__price__header .price__rate .price__currency' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price:hover .single__price__header .period__price' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price:hover .single__price__ribon' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price:hover .price__desc p' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price:hover .new__price' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price:hover .period__price' => 'color: {{VALUE}};',

                    '{{WRAPPER}} .single__price.price__active ul li' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price.price__active ul li i' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price.price__active .price_btn' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price.price__active .single__price__header .price__title h3' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price.price__active .single__price__header .price__rate .new__price' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price.price__active .single__price__header .price__rate .price__currency' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price.price__active .single__price__header .period__price' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price.price__active .single__price__ribon' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single__price.price__active .price__desc p' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price.price__active .new__price' => 'color: {{VALUE}} ;',
                    '{{WRAPPER}} .single__price.price__active .period__price' => 'color: {{VALUE}} ;',
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Background', 'element-ready-lite'),
                'types'    => ['classic', 'gradient'],
                'selector' => 'body {{WRAPPER}} .single__price.price__active',
            ]
        );
        ...
        if (false === ($query_results = get_transient($key))) {
            ...
            try {
                ...
                if (isset($json->success) && $json->success == true) {
                    $query_results = wp_json_encode($json->response->products[0]);
                }
            } catch (\Exception $ex) {
                $json = null;
            }
...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('pricing_area_attr')); ?>>
