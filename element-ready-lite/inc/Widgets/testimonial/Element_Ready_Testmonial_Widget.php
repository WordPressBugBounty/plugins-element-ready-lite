...
?>
		...
		<div <?php echo wp_kses($this->get_render_attribute_string('sldier_parent_attr'), array()); ?>>
			<div <?php echo wp_kses($this->get_render_attribute_string('testmonial_carousel_attr'), array()); ?>>
