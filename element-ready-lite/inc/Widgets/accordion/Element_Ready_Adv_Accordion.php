...
class Element_Ready_Adv_Accordion extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        * ------------------------------------------*/
        ...
        $this->add_control(
            'element_ready_adv_tabs_tab_toggle_bg_color',
            [
                'label'     => esc_html__('Background Color', 'element-ready-lite'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .element__ready__adv__accordion .element__ready__accordion__list .element__ready__accordion__header .toggle__icon' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'element_ready_accordion_show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'element_ready_adv_tabs_tab_toggle_active_bg_color',
            [
                'label'     => esc_html__('Background Active Color', 'element-ready-lite'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .element__ready__adv__accordion .element__ready__accordion__list .element__ready__accordion__header.active .toggle__icon' => 'background: {{VALUE}};',
                    '{{WRAPPER}} .element__ready__adv__accordion .element__ready__accordion__list:hover .element__ready__accordion__header .toggle__icon'  => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'element_ready_accordion_show_icon' => 'yes',
                ],
