...
?>
        <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_category_main_wrap')); ?>>

            <div <?php echo wp_kses_post($this->get_render_attribute_string('element_ready_category_wrap_attr')); ?>>
                ...
                <?php foreach ($settings['template_list'] as $item) : ?>
                    <div>
                        ...
                        if (!empty($item['template_id'] ?? '')) {
                            $element_ready_template_id = $item['template_id'];
