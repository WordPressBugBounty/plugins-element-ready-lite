...
class Page
{
    ...
    public function add_cpt_page()
    {
        ...
        add_submenu_page(
            ...
            'Header Footer',
            'manage_options',
            'edit.php?post_type=element-ready-hf-tpl'
        );
    ...
    function components_options()
    {
        ...
        if (!isset($_POST['_element_ready_hf_components']) || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['_element_ready_hf_components'])), 'element-ready-hf-components')) {
        ...
        // Save
        $validate_options = map_deep(wp_unslash($_POST['element-ready-hf-options']), 'sanitize_text_field');
