...
<?php
    ...
    public function save($post_id)
    {
        ...
        $nonce = sanitize_text_field(wp_unslash($_POST['element_ready_header_footer_nonce'] ?? ''));
        ...
        $template_type = sanitize_text_field(wp_unslash($_POST['element_ready_template_type'] ?? ''));
    ...
    public function page_save($post_id)
    {
        ...
        $header_type = sanitize_text_field(wp_unslash($_POST['element_ready_builder_header_layout_style'] ?? ''));
        $footer_type = sanitize_text_field(wp_unslash($_POST['element_ready_builder_footer_layout_style'] ?? ''));
    ...
    public function update_template($post_id, $post, $update)
    {
        ...
        if ($update):
            if (isset($_POST['page_template'])):
                $template = sanitize_text_field(wp_unslash($_POST['page_template']));
